...
def level_rpo_pass_manager(pass_manager_config: PassManagerConfig) -> PassManager:
    """Level RPO pass manager: heavy optimization by noise adaptive qubit mapping and
