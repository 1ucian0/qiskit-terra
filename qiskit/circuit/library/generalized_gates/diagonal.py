...
class Diagonal(QuantumCircuit):
    ...
    classical_function can be seen as a diagonal gate with {+1, -1} on the diagonals. Such
    an classical_function will induce a +1 or -1 phase on the amplitude of any corresponding
    basis state.
